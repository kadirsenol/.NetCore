...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<SiparislerinUrunIsimleri> SiparislerinUrunIsimleris { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasMany(d => d.CustomerTypes).WithMany(p => p.Ids)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("Id", "CustomerTypeId").IsClustered(false);
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasMany(d => d.Territories).WithMany(p => p.Ids)
                .UsingEntity<Dictionary<string, object>>(
                    "EmployeeTerritory",
                    ...
                    j =>
                    {
                        j.HasKey("Id", "TerritoryId").IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.Id, e.ProductId }).HasName("PK_Order_Details");

            entity.ToTable("Order Details", tb =>
                {
                    tb.HasTrigger("stokkontrol");
                    tb.HasTrigger("stokkontrol1");
                    tb.HasTrigger("stokkontroll");
                    tb.HasTrigger("stokkontrolll");
                });

            entity.HasIndex(e => e.Id, "OrderID");

            entity.HasIndex(e => e.Id, "OrdersOrder_Details");
        ...
        modelBuilder.Entity<SiparislerinUrunIsimleri>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("SiparislerinUrunIsimleri");

            entity.Property(e => e.Fiyat).HasColumnType("money");
            entity.Property(e => e.Kategori).HasMaxLength(15);
            entity.Property(e => e.SiparisNo).HasColumnName("Siparis No");
            entity.Property(e => e.Urun).HasMaxLength(40);
        });
